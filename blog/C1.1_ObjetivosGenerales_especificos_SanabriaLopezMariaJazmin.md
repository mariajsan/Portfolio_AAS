...
Desarrolllar un sistema que unifique el conocimiento de la empresa, haciéndola universal y accesible para todos los miembros de la organización.

3. Especifique tres **objetivos específicos**, recordándose que deben ser medibles, cuantificables y logrables.
4. Elabore el diagrama del **modelo del negocio** que se visualiza para el caso de estudio, utilizando BPMN y la herramienta case Bizagi.

 ![negocio](https://github.com/mariajsan/Portfolio_AAS/blob/main/img/Modelo_Negocio.png)
