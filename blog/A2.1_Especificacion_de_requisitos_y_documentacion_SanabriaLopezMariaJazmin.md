...
|📁 **Requisito RFN-01: Nombre del requisito**  |
|:----|
| **Detalle:** <br> 
...
|📁 **Requisito RFN-02: Nombre del requisito**  |
|:----|
| **Detalle:** <br> 
|**Precondición:** <br> :one: <br> :two: <br> :three: |
|**Secuencia normal** <br> :one: <br> :two:  <br> :three:  <br> :four:  <br>
...
|📁 **Requisito RFN-03: Nombre del requisito**  |
|:----|
| **Detalle:** <br> 
|**Precondición:** <br> :one: <br> :two: <br> :three: |
|**Secuencia normal** <br> :one: <br> :two:  <br> :three:  <br> :four:  <br>
...
|📁 **Requisito RFN-04: Nombre del requisito**  |
|:----|
| **Detalle:** <br> 
|**Precondición:** <br> :one: <br> :two: <br> :three: |
|**Secuencia normal** <br> :one: <br> :two:  <br> :three:  <br> :four:  <br>
...
|📁 **Requisito RFN-05: Nombre del requisito**  |
|:----|
| **Detalle:** <br> 
|**Precondición:** <br> :one: <br> :two: <br> :three: |
|**Secuencia normal** <br> :one: <br> :two:  <br> :three:  <br> :four:  <br>
...
|📁 **Requisito RFN-06: Nombre del requisito**  |
|:----|
| **Detalle:** <br> 
|**Precondición:** <br> :one: <br> :two: <br> :three: |
|**Secuencia normal** <br> :one: <br> :two:  <br> :three:  <br> :four:  <br>
...
|📁 **Requisito RFN-07: Nombre del requisito**  |
|:----|
| **Detalle:** <br> 
|**Precondición:** <br> :one: <br> :two: <br> :three: |
|**Secuencia normal** <br> :one: <br> :two:  <br> :three:  <br> :four:  <br>
...
|📁 **Requisito RFN-08: Nombre del requisito**  |
|:----|
| **Detalle:** <br> 
|**Precondición:** <br> :one: <br> :two: <br> :three: |
|**Secuencia normal** <br> :one: <br> :two:  <br> :three:  <br> :four:  <br>
...
|📁 **Requisito RFN-09: Nombre del requisito**  |
|:----|
| **Detalle:** <br> 
|**Precondición:** <br> :one: <br> :two: <br> :three: |
|**Secuencia normal** <br> :one: <br> :two:  <br> :three:  <br> :four:  <br>
...
|📁 **Requisito RFN-10: Nombre del requisito**  |
|:----|
| **Detalle:** <br> 
|**Precondición:** <br> :one: <br> :two: <br> :three: |
|**Secuencia normal** <br> :one: <br> :two:  <br> :three:  <br> :four:  <br>
